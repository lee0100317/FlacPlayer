...
int mainFuns(char *pszSrc, char *pszDes)
{
	FLAC__bool ok = true;
...
//		fprintf(stderr, "usage: %s infile.flac outfile.wav\n", argv[0]);
	...
	init_status = FLAC__stream_decoder_init_file(decoder, pszSrc, write_callback, metadata_callback, error_callback, /*client_data=*/fout);
